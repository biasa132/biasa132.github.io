...
# Folder utama
# ----------------------------
ROOTFS_FOLDER = "./rootfs"       # tempat rootfs Ubuntu
DOWNLOADS_FOLDER = "./downloads" # file hasil download di luar rootfs
PACKAGES_FOLDER = "./packages"   # file / package dari rootfs
ADMIN_FOLDER = "./admin"
BACKUP_FOLDER = "./backup"

# Pastikan folder ada
for folder in [ROOTFS_FOLDER, DOWNLOADS_FOLDER, PACKAGES_FOLDER, ADMIN_FOLDER, BACKUP_FOLDER]:
