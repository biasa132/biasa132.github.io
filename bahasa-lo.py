# bahasalo.py - Mini REPL Interpreter Bahasa Lo + Proot-distro
import re
import subprocess
...
def proses_baris(b):
    ...
    # Semua perintah lain dijalankan di Linux
    try:
...
def repl():
    print("Selamat datang di Mini Bahasa Lo (REPL + Proot-distro)")
